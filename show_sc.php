...
$sub_name = $dba['sub_name'];
	...
	?>
		...
		<th><b style="font-size: 16px;">รายวิชา</b></th>
					<?php
				if(isset($data_arr) && count($data_arr)>0){
					//echo $data_arr['A16'];
					
				?>
		<th height="80"  align="justify"><span class="textAlignVer"><?=$data_arr['F6'];?></span></th>
			
		<th height="70" align="justify"><span class="textAlignVer"><?=$data_arr['G6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['H6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['I6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['J6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['K6'];?></span></th>
		<th height="70" align="justify"><span class="textAlignVer"><?=$data_arr['L6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['M6'];?></span></th>
		<th height="70" align="justify"><span class="textAlignVer"><?=$data_arr['N6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['O6'];?></span></th>
		<th height="70" align="justify"><span class="textAlignVer"><?=$data_arr['P6'];?></span></th>
        <th height="70" align="justify"><span class="textAlignVer"><?=$data_arr['Q6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['R6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['S6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['T6'];?></span></th>
		<th height="75" align="justify"><span class="textAlignVer"><?=$data_arr['U6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['V6'];?></span></th>
		<th height="70"  align="justify"><span class="textAlignVer"><?=$data_arr['W6'];?></span></th>
		<th height="75"  align="justify"><span class="textAlignVer"><?=$data_arr['X6'];?></span></th>
...
<?php
				...
				?>
                  <tr>
					  ...
					  <td width="250" height="25"><b style="font-size: 14px;"><?=$sub_name;?></b></td>
					 ...
					 <td class="text-center" ><?=$allDataInSheet[$i]["I"];?></td>
					  ...
					  <td class="text-center" ><?=$allDataInSheet[$i]["W"];?></td>
					   <td class="text-center" ><?=$allDataInSheet[$i]["X"];?></td>
