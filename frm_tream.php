...
<body class="bg-dark">
  ...
  <<div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">ภาคเรียนการศึกษา</div>
      <div class="card-body">
		  
	
		  
        <form method="post" action="upload_tream.php" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="col-md-12">
                 <div class="form-label-group">
                  <input type="text" name="class" class="form-control" value=" " placeholder="กลุ่มเรียน" required="required">
